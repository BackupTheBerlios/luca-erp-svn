...
from Generic.Box import Box
from Gtk2CompositeView import Gtk2CompositeView

class Gtk2Box(Box, Gtk2CompositeView):
    def _doSetSpacing(self, spacing):
        self._obj.set_spacing(spacing)

    def _doGetSpacing(self):
        return self._obj.get_spacing()
