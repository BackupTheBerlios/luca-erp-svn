...
and packing the widgets. This program shows off a few useful techniques
for programming \Cimarron{} applications. Before you try to understand
the program fully, you may want to try using it a bit, to get a feeling
for what it does. Try to answer these questions: what is the difference
between leaving an \class{Entry} with \kbd{Tab} or \kbd{Enter}? Can you
set the value of one of the \class{Entry}s to the empty string? What
happens to the case of letters you enter in the \class{Entry}s?
